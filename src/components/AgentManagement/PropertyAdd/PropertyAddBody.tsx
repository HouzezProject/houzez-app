    ...
    <PropertyAddFormContainer>
      <form noValidate onSubmit={onSubmit}>
        <GridContainer container spacing={3}>
          ...
          <Grid item xs={3}>
            <FormControlLabel
              control={<Switch value={propertyAttribute.preowned} onChange={handleChange("preowned")} />}
              label="preowned"
            />
          </Grid>
          ...
          <PropertyAddInputWithLabelShrink
            xs={3}
            label="Street"
            value={street}
            handleChange={handleChange}
            ...
            <Grid item xs={1.5} key={index}>
              <FormControlLabel
                control={
                  <Checkbox
                    size={"small"}
                    value={propertyAttribute.indoor}
                    name={item}
            ...
            <Grid item xs={1.5} key={index}>
              <FormControlLabel
                control={
                  <Checkbox
                    size={"small"}
                    value={propertyAttribute.outdoor}
                    name={item}
